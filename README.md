...
# Now in Production!
Work on this respository server stalled in July 2017 due to issues with orphaned files in the Akubra datastore that Fedora uses.  These issues were subsequently resolved in October 2017 (by identifying all the orphans and simply deleting them in the usual manner) and RepositoryX became the new PRODUCTION repository server for Digital Grinnell on 13-October-2017.  This project was updated on 18-October-2017 to include the latest copy of all key files from the production server.
...
*Note: These issues have already been addressed in the copy of solrconfig.xml found in this repository!*
